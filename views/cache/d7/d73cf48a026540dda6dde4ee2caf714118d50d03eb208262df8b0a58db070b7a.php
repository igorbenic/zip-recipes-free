...
/* footer.twig */
class __TwigTemplate_f49da0b8a98ed9b9b5504d74bb085ae59649b9bc0eb316ca0666666eea1e63c3 extends Twig_Template
{
...
<script>
    ";
        // line 9
        echo "    var baseurl = '";
        echo twig_escape_filter($this->env, ($context["url"] ?? null), "js", null, true);
        echo "';          // This variable is used by the editor plugin
    var plugindir = '";
        // line 10
        echo twig_escape_filter($this->env, ($context["pluginurl"] ?? null), "js", null, true);
        echo "';  // This variable is used by the editor plugin
    ";
        // line 12
        echo "</script>";
    ...
    {
        return new Twig_Source("", "footer.twig", "/Applications/MAMP/htdocs/rogierlankhorst/wp-content/plugins/zip-recipes-free/views/footer.twig");
    }
}
