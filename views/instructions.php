...
foreach($recipe->nested_instructions as $instruction) { ?>
	<?php if ( $instruction['type'] == 'image' ){ ?>
		<?php echo '</' . $list_type . '>';?>
		<img class="<?php if($settings['hide_print_image']) echo "zrdn-hide-print" ?>" src="<?php echo $instruction['attributes']['url']; ?>"
        ...
        />
		<?php echo '<' . $list_type . ' class="zrdn-list zrdn-instructions-list '.$list_class.'"">';?>
