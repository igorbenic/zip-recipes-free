...
You can get the [detailed installation instructions here](https://www.ziprecipes.net/knowledge-base-overview//). If you have more questions on how to use the plugin, feel free to reach out to us at [support@ziprecipes.net](mailto:support@ziprecipes.net).
...
Yes, we do! The premium version has automatically generated nutritional info, ratings, automatic serving adjustment, search by ingredient and easily created recipe galleries. You can learn about our premium features here: [https://www.ziprecipes.net/premium](https://www.ziprecipes.net/)
...
= 6.1.2 =
* Fix: pre php 7 compatibility

= 6.1.1 =
* Fix: when no language folder is present, no check on free languages files should be made

= 6.1.0 =
* improvement: HTML and CSS styled nutrition label
